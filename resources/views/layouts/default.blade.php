...
<head>
    ...
    <link rel="icon" type="image/x-icon" href="{{ env('APP_LINK') }}/favicon.ico">
...
<script src="https://cdnjs.cloudflare.com/ajax/libs/jquery.countdown/2.2.0/jquery.countdown.min.js"
    ...
    crossorigin="<!DOCTYPE html>
<html lang="en">

<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <link rel="icon" type="image/x-icon" href="{{ env('APP_LINK') }}/assets/images/bp-light.png">
    <meta http-equiv="X-UA-Compatible" content="ie=edge">
    <title>
        @if (request()->is('/'))
            {{ config('site.name') }}
